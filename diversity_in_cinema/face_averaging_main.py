...
from diversity_in_cinema.params import BUCKET_NAME, BUCKET_NAME_STREAMLIT
from diversity_in_cinema.utils_cloud import gcp_file_names, gcp_subdir_names, upload_image_to_gcp, bulk_get_image_pixels
...
def main():
    ...
    processed_movies = [str(x).split("/")[1] for x in client.
                        list_blobs(BUCKET_NAME, prefix='face_images')]
    ...
    for movie_name in tqdm(processed_movies):
        ...
        try:
            print(av.shape)
            image_filename = 'faces/' + movie_name + '_avg_face.jpg'
